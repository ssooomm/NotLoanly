...
<template>
    <div class="main-container">
      ...
      <div class="tabs">
        <button @click="activeTab = 'dashboard'" class="tab" :class="{ active: activeTab === 'dashboard' }">요약</button>
        <button @click="activeTab = 'spending'" class="tab" :class="{ active: activeTab === 'spending' }">상환현황</button>
        <button @click="activeTab = 'analysis'" class="tab" :class="{ active: activeTab === 'analysis' }">소비분석</button>
      </div>
      <div class="content">
